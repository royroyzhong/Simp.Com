...
### Intro: 
We deisnged an e-commerce platform which supports roles from guests and buyer to seller. We included a variety of features from upload products, drag & drop files and cart operations to more advanced live chat and data visulization. 
